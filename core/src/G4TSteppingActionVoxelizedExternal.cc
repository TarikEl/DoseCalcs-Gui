...
//
// 
/// \file G4TSteppingActionVoxelizedExternal.cc
/// \brief Implementation of the G4TSteppingActionVoxelizedExternal class
...
//G4ThreadLocal G4double G4TSteppingActionVoxelizedExternal::edep;
//G4ThreadLocal G4String G4TSteppingActionVoxelizedExternal::reg;
//G4ThreadLocal unsigned int  G4TSteppingActionVoxelizedExternal::CN;

G4TSteppingActionVoxelizedExternal::G4TSteppingActionVoxelizedExternal(G4TRunAction* ra):G4UserSteppingAction(),RunAction(ra){}

G4TSteppingActionVoxelizedExternal::~G4TSteppingActionVoxelizedExternal(){}

void G4TSteppingActionVoxelizedExternal::UserSteppingAction(const G4Step* step)
{
