...
G4THadrontherapyModulator::G4THadrontherapyModulator(): physiMotherMod(0),
...
{ 
    ...
    //ModulatorMessenger = new  G4THadrontherapyModulatorMessenger(this);
...
/////////////////////////////////////////////////////////////////////////////
G4THadrontherapyModulator::~G4THadrontherapyModulator()
{
    delete rm;
    delete []   Weight;
...
/////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyModulator::ModulatorDefaultProperties()
{
...
/////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyModulator:: ModulatorPropertiesFromFile(G4String Name)
{
    delete [] Weight;
    delete []	StepThickness;
    delete []	StartingAngle;
    ...
    if(!File.is_open())
    {
        ...
        G4Exception("G4THadrontherapyModulator::ModulatorPropertiesFromFile( )", "Hadrontherapy0009"
...
////////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyModulator::GetStepInformation()
{
...
/////////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyModulator::BuildModulator(G4VPhysicalVolume* motherVolume)
{
...
///////////////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyModulator::BuildSteps()
{
    //----------------------------------------------------------
...
// Messenger values
/////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyModulator::SetModulatorAngle(G4double angle)
{
...
void G4THadrontherapyModulator::SetModulatorMaterial(G4String Material)
{
...
void G4THadrontherapyModulator::SetModulatorPosition(G4ThreeVector Pos)
{
...
void G4THadrontherapyModulator::SetModulatorInnerRadius(G4double newvalue)
{
...
void G4THadrontherapyModulator::SetModulatorOuterRadius(G4double newvalue)
{
...
/////////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyModulator:: GetDataFromFile(G4String value)
