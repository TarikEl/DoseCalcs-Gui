...
#include "G4THadrontherapyAnalysisFileMessenger.hh"
#include "G4SystemOfUnits.hh"
#include <time.h>

G4THadrontherapyAnalysis* G4THadrontherapyAnalysis::instance = 0;
/////////////////////////////////////////////////////////////////////////////

G4THadrontherapyAnalysis::G4THadrontherapyAnalysis()
{
    fMess = new G4THadrontherapyAnalysisFileMessenger(this);
}
...
/////////////////////////////////////////////////////////////////////////////
G4THadrontherapyAnalysis* G4THadrontherapyAnalysis::GetInstance(){

    if (instance == 0) instance = new G4THadrontherapyAnalysis;
    return instance;
}
...
// messenger commands
// defined in the G4THadrontherapyAnalysisFileMessenger.cc class file
