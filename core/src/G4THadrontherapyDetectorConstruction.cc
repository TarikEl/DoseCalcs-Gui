...
//#include "G4THadrontherapyAnalysis.hh"
//#include "HadrontherapyLet.hh"
#include "G4TPassiveProtonBeamLine.hh"
...
//G4THadrontherapyDetectorConstruction* G4THadrontherapyDetectorConstruction::instance = 0;
/////////////////////////////////////////////////////////////////////////////
G4THadrontherapyDetectorConstruction::G4THadrontherapyDetectorConstruction(G4VPhysicalVolume* physicalTreatmentRoom)
...
aRegion(0)
{
    ...
    /* NOTE! that the G4THadrontherapyDetectorConstruction class
     ...
     * like the G4TPassiveProtonBeamLine, ...
     */
    
    // Messenger to change parameters of the phantom/detector geometry
    //detectorMessenger = new G4THadrontherapyDetectorMessenger(this);
    ...
    G4THadrontherapyDetectorROGeometry* RO = new G4THadrontherapyDetectorROGeometry(motherPhys);
    ...
    std::cout << " detectorSizeX " << " " << detectorSizeX
              << " detectorSizeY " << " " << detectorSizeY
              << " detectorSizeZ " << " " << detectorSizeZ
              << " numberOfVoxelsAlongX " << " " << numberOfVoxelsAlongX
              << " numberOfVoxelsAlongY " << " " << numberOfVoxelsAlongY
              << " numberOfVoxelsAlongZ " << " " << numberOfVoxelsAlongZ
              << std::endl;
...
G4VPhysicalVolume* G4THadrontherapyDetectorConstruction::Construct()
{
    return motherPhys;
}

/////////////////////////////////////////////////////////////////////////////
G4THadrontherapyDetectorConstruction::~G4THadrontherapyDetectorConstruction()
{
...
/////////////////////////////////////////////////////////////////////////////
//G4THadrontherapyDetectorConstruction* G4THadrontherapyDetectorConstruction::GetInstance()
//{
//    return instance;
//}
...
void G4THadrontherapyDetectorConstruction::ConstructPhantom()
{
...
// can be stored.
void G4THadrontherapyDetectorConstruction::ConstructDetector(){
...
///////////////////////////////////////////////////////////////////////
void G4THadrontherapyDetectorConstruction::InitializeDetectorROGeometry( G4THadrontherapyDetectorROGeometry* RO, G4ThreeVector detectorToWorldPosition)
{
...
void G4THadrontherapyDetectorConstruction::VirtualLayer(G4bool Varbool)
{
...
///////////////////////////////////////////////////////////////////////
void  G4THadrontherapyDetectorConstruction::ParametersCheck()
{
    ...
    if (!IsInside(detectorSizeX,
        ...
        G4Exception("G4THadrontherapyDetectorConstruction::ParametersCheck()", "Hadrontherapy0001", FatalException, "Error: Detector is not fully inside Phantom!");
    
    // Check Detector sizes respect to the voxel ones
    
    if ( detectorSizeX < sizeOfVoxelAlongX) {
        G4Exception("G4THadrontherapyDetectorConstruction::ParametersCheck()", "Hadrontherapy0002", FatalException, "Error:  Detector X size must be bigger or equal than that of Voxel X!");
    }
    if ( detectorSizeY < sizeOfVoxelAlongY) {
        G4Exception(" G4THadrontherapyDetectorConstruction::ParametersCheck()", "Hadrontherapy0003", FatalException, "Error:  Detector Y size must be bigger or equal than that of Voxel Y!");
    }
    if ( detectorSizeZ < sizeOfVoxelAlongZ) {
        G4Exception(" G4THadrontherapyDetectorConstruction::ParametersCheck()", "Hadrontherapy0004", FatalException, "Error:  Detector Z size must be bigger or equal than that of Voxel Z!");
    }
}

///////////////////////////////////////////////////////////////////////
G4bool G4THadrontherapyDetectorConstruction::SetPhantomMaterial(G4String material)
{
...
/////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyDetectorConstruction::SetPhantomSize(G4double sizeX, G4double sizeY, G4double sizeZ)
{
...
/////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyDetectorConstruction::SetDetectorSize(G4double sizeX, G4double sizeY, G4double sizeZ)
{
...
/////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyDetectorConstruction::SetVoxelSize(G4double sizeX, G4double sizeY, G4double sizeZ)
{
...
///////////////////////////////////////////////////////////////////////
void G4THadrontherapyDetectorConstruction::SetPhantomPosition(G4ThreeVector pos)
{
    phantomPosition = pos;
}

/////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyDetectorConstruction::SetDetectorToPhantomPosition(G4ThreeVector displ)
{
    detectorToPhantomPosition = displ;
}

void G4THadrontherapyDetectorConstruction::SetVirtualLayerPosition(G4ThreeVector position)
{
...
/////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyDetectorConstruction::UpdateGeometry()
{
    /*
    ...
    numberOfVoxelsAlongZ = G4lrint(detectorSizeZ / sizeOfVoxelAlongZ);
    sizeOfVoxelAlongZ = ( detectorSizeZ / numberOfVoxelsAlongZ );
    G4TPassiveProtonBeamLine *ppbl= (G4TPassiveProtonBeamLine*)
    
    G4RunManager::GetRunManager()->GetUserDetectorConstruction();
    
    G4THadrontherapyDetectorROGeometry* RO = (G4THadrontherapyDetectorROGeometry*) ppbl->GetParallelWorld(0);
    ...
    //matrix = G4THadrontherapyAnalysis::GetInstance(numberOfVoxelsAlongX,
    //                                          numberOfVoxelsAlongY,
    //                                          numberOfVoxelsAlongZ,
    //                                          massOfVoxel);
...
/////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyDetectorConstruction::CheckOverlaps()
{
...
/////////////////////////////////////////////////////////////////////////////
void G4THadrontherapyDetectorConstruction::PrintParameters()
{
