...
#ifndef G4THadrontherapyAnaMANAGER_HH
#define G4THadrontherapyAnaMANAGER_HH 1

//class G4THadrontherapyAnaFileMessenger;

/**
 * A class for connecting the simulation to an analysis package.
 */
class G4THadrontherapyAna
{
private:
    /**
...
public:
     ...
     */
    static G4THadrontherapyAna* GetInstance();
    
    
    
    static G4THadrontherapyAna* instance;
    //HadrontherapyAnaFileMessenger* fMess;
