...
#ifndef G4TPassiveProtonBeamLine_H
#define G4TPassiveProtonBeamLine_H 1
...
class G4TPassiveProtonBeamLineMessenger;
class G4THadrontherapyDetectorROGeometry;

class G4TPassiveProtonBeamLine : public G4VUserDetectorConstruction
{
public:

    G4TPassiveProtonBeamLine();
    ~G4TPassiveProtonBeamLine();
    ...
    static G4TPassiveProtonBeamLine* GetInstance();
...
private:
    static G4TPassiveProtonBeamLine* instance;
    //passive proton line dimensions
    void SetDefaultDimensions();
    void ConstructG4TPassiveProtonBeamLine();
    
    G4THadrontherapyModulator* modulator; // Pointer to the modulator
    // geometry component
    //G4TPassiveProtonBeamLineMessenger* passiveMessenger;
