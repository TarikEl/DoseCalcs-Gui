...
//
//
#ifndef G4THadrontherapyDetectorROGeometry_h
#define G4THadrontherapyDetectorROGeometry_h
...
class G4THadrontherapyDetectorROGeometry
        //: public G4VUserParallelWorld
{
public:
  G4THadrontherapyDetectorROGeometry(G4VPhysicalVolume* WorldPhysicalVolume);
  ~G4THadrontherapyDetectorROGeometry();
