...
//
// 
/// \file G4TModifiedSteppingAction.hh
/// \brief Definition of the G4TModifiedSteppingAction class

#ifndef G4TModifiedSteppingAction_h
...
{
public:
    G4TModifiedSteppingAction(G4TRunAction* runAction);
    virtual ~G4TModifiedSteppingAction();
