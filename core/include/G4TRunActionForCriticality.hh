...
#ifndef G4TRunActionForCriticality_h
#define G4TRunActionForCriticality_h 1
...
class G4TRunActionForCriticality : public G4UserRunAction
{
public:

    G4TRunActionForCriticality();
    ~G4TRunActionForCriticality();
...
private:
    ...
    G4ThreadLocal static std::map<G4int,std::map<G4String,unsigned long long int>> ParticleProduction;
    ...
    std::map<G4int,std::map<G4String,unsigned long long int>> ParticleProduction;
#endif
