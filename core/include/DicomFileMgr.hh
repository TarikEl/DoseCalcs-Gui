...
public:
    ...
    void GenerateDICOMTextGeometryFile();

    //void setDicomType(G4String n){DicomType = n;}
    void setDicomFilesDirPath(G4String n){DicomFilesDirPath = n;}
    void setDicomOutTextName(G4String n){theFileOutName = n;}

    std::map<G4String, double> getPETGeneralData()const { return PETGeneralData ;}
    std::map<G4String, std::vector<double>> getPETGeneralDateData()const { return PETGeneralDateData ;}
    std::vector<double> getSerieAcquisitionsDataVec()const { return SerieAcquisitionsDataVec ;}
...
private:
    ...
    std::vector<double> SerieDataVec;
    std::map<double, std::vector<unsigned int>> Map;

    G4int FileInc;
    std::vector<double> SerieAcquisitionsDataVec;
    std::map<G4String, double> PETGeneralData ;
