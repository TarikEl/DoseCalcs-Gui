...
//
// 
/// \file G4TSteppingAction.hh
/// \brief Definition of the G4TSteppingAction class

#ifndef G4TSteppingAction_h
...
class G4TSteppingAction : public G4UserSteppingAction
{
public:
    G4TSteppingAction(G4TRunAction* runAction);
    virtual ~G4TSteppingAction();
