...
#ifndef G4THadrontherapyDetectorConstruction_H
#define G4THadrontherapyDetectorConstruction_H 1
...
//class G4THadrontherapyAnalysis;
...
public:
    ...
    G4THadrontherapyDetectorConstruction(G4VPhysicalVolume*);
    
    ~G4THadrontherapyDetectorConstruction();
    
public:
    //static G4THadrontherapyDetectorConstruction* GetInstance();
    void InitializeDetectorROGeometry(G4THadrontherapyDetectorROGeometry*, G4ThreeVector detectorToWorldPosition);
...
private:
    //static G4THadrontherapyDetectorConstruction* instance;
    //HadrontherapyDetectorMessenger* detectorMessenger;
    
    G4VisAttributes* skyBlue;
    G4VisAttributes* red;
    
    G4THadrontherapyDetectorROGeometry* detectorROGeometry; // Pointer to ROGeometry
    //G4THadrontherapyAnalysis*             matrix;
